module github.com/rootmout/pulsar-heartbeat/v10
...
require (
	...
	github.com/datastax/pulsar-heartbeat v0.0.5
...
replace github.com/datastax/pulsar-heartbeat v0.0.5 => github.com/rootmout/pulsar-heartbeat/v10 v10.0.8
